          ...
          <div className="mx-auto max-w-sm xl:max-w-md">
            ...
            <div className="space-y-6">
              <h2 className="text-3xl font-bold text-white leading-tight">
                The Raven Sees What Others Miss.
              ...
              <p className="text-slate-300 text-lg leading-relaxed">
                Advanced API security monitoring and threat detection for modern applications.
              </p>
              ...
              <div className="flex items-center text-sm text-slate-400">
                ...
                <span className="ml-3">Trusted by 500+ security teams</span>
              </div>
            </div>
          </div>
        </div>
